...
- Read-only GitHub inspection confirms the web `main` branch is currently unprotected and both remotes have no visible workflow runs; this is recorded as a push/admin gate rather than inferred CI evidence.
