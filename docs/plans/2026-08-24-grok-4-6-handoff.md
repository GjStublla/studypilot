...
- Web commits `3212aca` and `d5657d8` add direct expired-session refresh/redirect, network-failure, login-error, OAuth-error, successful email-login, auto-confirmed-signup, and email-confirmation-signup characterization, and restore keyboard tab access to both password-visibility buttons. The current web suite is 19 Vitest files / 106 tests; web Playwright remains 4/4.
