...
- `npm run verify:release` with public placeholder values after `c970bd0`: web tests (19 files/106 tests), claim tests/validation, production build, and built-environment scan passed; hosted function allowlist was visibly skipped because `SUPABASE_ACCESS_TOKEN` was absent.
