...
- The current `npm run verify:release` run after `14395cd`: web tests (19 files/106 tests), claim tests (8/8), six-document claim validation, owner-aware submission tests (7/7), production build, and built-environment scan passed; hosted function allowlist was visibly skipped because `SUPABASE_ACCESS_TOKEN` was absent.
